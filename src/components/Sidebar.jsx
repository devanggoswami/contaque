...
import { LayoutDashboard, Database, Zap, Sparkles, ShieldCheck, Menu, X, LogOut, User, Globe } from 'lucide-react';
      ...
      <aside className={`sidebar ${mobileOpen ? 'mobile-open' : ''}`}>
        ...
        <nav className="sidebar-nav">
          ...
          >
            ...
            <span className="nav-badge-neutral">NEW</span>
          </NavLink>
        </nav>
        ...
        <div className="sidebar-footer">
          ...
          <div className="system-status-card">
            <div className="status-indicator">
              ...
              <span className="status-text">Scraper Engine</span>
            </div>
            <div className="engine-status">
              <ShieldCheck size={14} />
              <span>Multi-Source Active</span>
            </div>
          </div>
        </div>
      </aside>
