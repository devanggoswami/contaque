  ...
  return (
    ...
    >
      ...
      <section id="refund-2" className="legal-section">
        ...
        <p className="legal-text">
          When you initiate a payment for a subscription plan upgrade (<strong>Value Plus</strong> at ₹299/mo or <strong>Value Pack</strong> at ₹499/mo) via our integrated checkout:
        </p>
